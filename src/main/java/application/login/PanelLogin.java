...
public class PanelLogin extends JPanel{
   ...
   public void createPanel(){
       ...
       labelLogo.setIcon(new ImageIcon("src/main/java/application/image/exercise.png"));
       
       labelSufLogo.setBounds(180, 80, 65, 65);
       labelSufLogo.setIcon(new ImageIcon("src/main/java/application/image/line.png"));
       ...
       textFieldUsername.setPrefixIcon(new ImageIcon("src/main/java/application/image/user.png"));
       
       textFieldPassword.setBounds(115, 310, 290, 50);
       textFieldPassword.setHint("Password");
       textFieldPassword.setPrefixIcon(new ImageIcon("src/main/java/application/image/padlock.png"));
